...
const buttonVariants = cva(
  "inline-flex items-center py-[10px] px-[10px] justify-center gap-2 whitespace-nowrap rounded-full text-base font-semibold transition-colors ring-offset-white",
  {
    variants: {
      variant: {
        default:
