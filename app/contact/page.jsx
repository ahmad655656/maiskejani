...
const Contact = () => {
  return <motion.section className="py-6" intial={{ opacity: 0 }} animate={{ opacity: 1, transition: {delay: 2.4, duration: 0.4, ease: "easeIn"}, }}>
            ...
            <Select>
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  <SelectItem value="cst">Correcting Code Errors</SelectItem>
                  <SelectItem value="mst">Logo Design</SelectItem>
                  <SelectItem value="tst">Video Design</SelectItem>
                </SelectGroup>
              </SelectContent>
            </Select>
            <Textarea className="h-[200px]" placeholder="Type your message here" />
            <Button size="md" className="max-w-40 hover:text-primary/60" >Send message</Button>
          </form>
        </div>
